...
メッセンジャーチャンネルにメッセージを送信します。**멘션 기능 지원**: 특정 사용자 멘션 `[@사용자명](dooray://조직ID/members/멤버ID "member")` 또는 채널 전체 멘션 `[@Channel](dooray://조직ID/channels/채널ID "channel")` 사용 가능.
...
```json
{
  ...
  "arguments": {
    ...
    "text": "お疲れ様です。\nGYM_AI検証について、午後に資料を整理してお共有する予定です。\nよろしくお願いいたします。",
    "mention_members": [
      {
...
**결과 메시지 형식:**
```
[@菅野志穂](dooray://1708537451674140147/members/1653898942478787781 "member")
お疲れ様です。
GYM_AI検証について、午後に資料を整理してお共有する予定です。
よろしくお願いいたします。
```
